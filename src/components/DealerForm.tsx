...
const dealerBenefitsDict = {
  ...
  en: [
    { icon: TrendingUp, label: "Attractive Margins" },
    { icon: Headphones, label: "Marketing Support" },
    { icon: Truck, label: "Quick Supply" },
    { icon: BarChart3, label: "Growing Demand" },
  ]
};

export default function DealerForm() {
  const { language, t } = useLanguage();
  const dealerBenefits = t(dealerBenefitsDict);
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl md:text-5xl font-bold text-foreground mb-6">
            {t({ mr: "सरस्वती ॲग्रो फीड्स ", en: "Become a " })}
            <span className="text-primary">{t({ mr: "वितरक बना", en: "Saraswati Agro Feeds Dealer" })}</span>
          </h2>
          <div className="h-1.5 w-24 bg-accent mx-auto rounded-full mb-6"></div>
          <p className="text-lg text-muted-foreground">
            {t({
              mr: "आमच्या वाढत्या वितरक नेटवर्कचा भाग व्हा आणि यशस्वी व्यवसाय उभा करा",
              en: "Become part of our growing distributor network and build a successful business",
            })}
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          >
            <div>
              <h3 className="text-2xl font-bold text-foreground mb-6">
                {t({ mr: "वितरक होण्याचे फायदे", en: "Benefits of Becoming a Dealer" })}
              </h3>
            ...
            <div className="bg-primary/5 dark:bg-primary/10 border border-primary/20 rounded-2xl p-6">
              <h4 className="font-bold text-primary text-lg mb-4">{t({ mr: "आमच्याशी संपर्क साधा", en: "Contact Us" })}</h4>
          ...
          >
            <h3 className="text-xl font-bold text-foreground mb-6">
              {t({ mr: "चौकशी फॉर्म भरा", en: "Fill the Inquiry Form" })}
            </h3>
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>{t({ mr: "नाव *", en: "Full Name *" })}</FormLabel>
                      <FormControl>
                        <Input placeholder={t({ mr: "आपले पूर्ण नाव", en: "Your full name" })} data-testid="input-dealer-name" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>{t({ mr: "व्यवसायाचे नाव *", en: "Business Name *" })}</FormLabel>
                      <FormControl>
                        <Input placeholder={t({ mr: "आपल्या व्यवसायाचे नाव", en: "Name of your business" })} data-testid="input-dealer-business" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>{t({ mr: "मोबाईल नंबर *", en: "Mobile Number *" })}</FormLabel>
                        <FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>{t({ mr: "ईमेल", en: "Email Address" })}</FormLabel>
                        <FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>{t({ mr: "संदेश", en: "Message" })}</FormLabel>
                      <FormControl>
                        <Textarea placeholder={t({ mr: "आपला संदेश येथे लिहा...", en: "Write your message here..." })} rows={3} data-testid="input-dealer-message" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <Button type="submit" size="lg" className="w-full gap-2 rounded-full mt-2" data-testid="button-dealer-submit">
                  ...
                  {t({ mr: "चौकशी पाठवा", en: "Send Inquiry" })}
                </Button>
              </form>
            </Form>
          </motion.div>
