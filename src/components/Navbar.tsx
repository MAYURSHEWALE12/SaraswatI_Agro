...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <nav 
        className="lg:hidden border-t border-gray-200 dark:border-slate-800 shadow-[0_-10px_40px_rgba(0,0,0,0.15)] pb-3 pt-1 bg-white dark:bg-slate-950 transition-colors"
        style={{ position: 'fixed', bottom: 0, left: 0, right: 0, zIndex: 2147483647 }}
      >
        <div className="flex items-center justify-around px-2 py-2">
          {/* Home */}
          <a href="#hero" className="flex flex-col items-center gap-1 p-2 text-gray-500 dark:text-gray-400 hover:text-emerald-600 dark:hover:text-emerald-400 active:scale-95 transition-all">
          ...
          {/* Products */}
          <a href="#products" className="flex flex-col items-center gap-1 p-2 text-gray-500 dark:text-gray-400 hover:text-emerald-600 dark:hover:text-emerald-400 active:scale-95 transition-all">
          ...
          <a href="#customized-feed" className="relative -top-5 flex flex-col items-center group active:scale-95 transition-transform">
            <div className="w-14 h-14 bg-gradient-to-tr from-amber-500 to-amber-400 rounded-full flex items-center justify-center text-white shadow-lg shadow-amber-500/40 border-4 border-white dark:border-slate-950 transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m22 2-7 20-4-9-9-4Z"/><path d="M22 2 11 13"/></svg>
            </div>
            <span className="text-[10px] font-bold text-amber-600 dark:text-amber-500 mt-1">{t({ mr: "कस्टम फीड", en: "Custom" })}</span>
          </a>

          {/* About */}
          <a href="#about" className="flex flex-col items-center gap-1 p-2 text-gray-500 dark:text-gray-400 hover:text-emerald-600 dark:hover:text-emerald-400 active:scale-95 transition-all">
          ...
          {/* Contact */}
          <a href="#contact" className="flex flex-col items-center gap-1 p-2 text-gray-500 dark:text-gray-400 hover:text-emerald-600 dark:hover:text-emerald-400 active:scale-95 transition-all">
